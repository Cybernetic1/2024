...
\begin{itemize}
	...
	\item By a similar argument, 
		\begin{equation}
		\vcenter{\hbox{\includegraphics[scale=0.15]{hypercube.png}}}
		\nonumber
		\end{equation}
\end{itemize}
\end{frame}
...
\begin{equation}
\vcenter{\hbox{\includegraphics[scale=0.1]{hair-brush.png}}}
\nonumber
\end{equation}
...
\begin{frame}
\frametitle{``Algebraic-logical'' neural networks}
\fontsize{10pt}{8}\selectfont
\begin{itemize}
