...
\item \textbf{Modality} = synonym for possible world, a terminology used in John L Bell's book\footnote{Toposes and Local Set Theories [J L Bell 1996]}
}
\end{itemize}
...
\item A proposition is equivalent to the set of possible worlds in which it is true (= set of open sets).  These are known as ``UCLA propositions'' after researchers at the University of California
}
