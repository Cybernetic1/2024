...
\begin{itemize}
	...
	\item By the construct of UCLA propositions, Kripke interpretations and frame-valued interpretations can be made to coincide, except that in the Kripke interpretation we have the extra information that each frame element belongs to a world $k$.
